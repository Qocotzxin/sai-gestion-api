...
export const ERROR = {
  UNAUTHORIZED: {
    CODE: 401,
    MESSAGE: 'FORMS_ERRORS.UNAUTHORIZED'
  },
  FORBIDDEN: {
    CODE: 403,
    MESSAGE: 'FORMS_ERRORS.FORBIDDEN'
  },
  NOT_FOUND: {
    CODE: 404,
    MESSAGE: 'FORMS_ERRORS.NOT_FOUND'
  },
  INTERNAL: {
    CODE: 500,
    MESSAGE: 'FORMS_ERRORS.INTERNAL'
  },
  CONNECTION: {
    CODE: 503,
    MESSAGE: 'FORMS_ERRORS.CONNECTION'
  },
  UNKNOWN: {
    CODE: 0,
    MESSAGE: 'FORMS_ERRORS.UNKNOWN'
  }
};
